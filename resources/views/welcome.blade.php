                ...
                <main class="mt-12">
                    ...
                    <div class="flex flex-wrap md:flex-no-wrap space-x-0 md:space-x-6 mb-16">
                        ...
                        <div class="mb-4 lg:mb-0  p-4 lg:p-0 w-full md:w-4/7 relative rounded block">
                            <img src="{{ asset('media/8/jamie-street-_pIV1xkJedY-unsplash.jpg') }}" class="rounded-md object-cover w-full h-64">
                            <span class="text-green-700 text-sm hidden md:block mt-4"> Street Art </span>
                        ...
                        <div class="w-full md:w-4/7">
                            ...
                            <div class="rounded w-full flex flex-col md:flex-row mb-10">
                                <img src="{{ asset('images/proj3.jpg') }}" class="block md:hidden lg:block rounded-md h-64 md:h-32 m-4 md:m-0" />
                                <div class="bg-white rounded px-4">
                                    <span class="text-green-700 text-sm hidden md:block"> Artistic Painting </span>
                            ...
                            <!-- post 2 -->
                            <div class="rounded w-full flex flex-col md:flex-row mb-10">
                                <img src="{{ asset('images/proj9.jpg') }}" class="block md:hidden lg:block rounded-md h-64 md:h-32 m-4 md:m-0" />
                                <div class="bg-white rounded px-4">
                                    <span class="text-green-700 text-sm hidden md:block"> Musique </span>
                                    <div class="md:mt-0 text-gray-800 font-semibold text-xl mb-2">
                            ...
                            <!-- post 3 -->
                            <div class="rounded w-full flex flex-col md:flex-row mb-10">
                                <img src="{{ asset('images/proj10.jpg') }}" class="block md:hidden lg:block rounded-md h-64 md:h-32 m-4 md:m-0" />
                                <div class="bg-white rounded px-4">
                                    <span class="text-green-700 text-sm hidden md:block"> Construction </span>
                                    <div class="md:mt-0 text-gray-800 font-semibold text-xl mb-2">
                            ...
                            <!-- post 4 -->
                            <div class="rounded w-full flex flex-col md:flex-row mb-10">
                                <img src="{{ asset('images/proj.jpg') }}" class="block md:hidden lg:block rounded-md h-64 md:h-32 m-4 md:m-0" />
                                <div class="bg-white rounded px-4">
                                    <span class="text-green-700 text-sm hidden md:block"> Pottery </span>
                                    <div class="md:mt-0 text-gray-800 font-semibold text-xl mb-2">
                                        Advice me cousin an spring of needed. Tell use paid law ever yet new.
                                    </div>
                                    <p class="block md:hidden p-2 pl-0 pt-1 text-sm text-gray-600">
                    ...
                    <div class="flex mt-16 mb-4 px-4 lg:px-0 items-center justify-between">
                        <h2 class="font-bold text-3xl">Latest Art-Projects</h2>
                    ...
                    <div class="block space-x-0 lg:flex lg:space-x-6">
                        ...
                        <div class="rounded w-full lg:w-1/2 lg:w-1/3 p-4 lg:p-0">
                            <img src="{{ asset('images/proj88.jpg') }}" class="w-5/5 h-3/5 rounded" alt="technology" />
                            <div class="p-4 pl-0">
                        ...
                        <div class="rounded w-full lg:w-1/2 lg:w-1/3 p-4 lg:p-0">
                            <img src="{{ asset('images/proj5.jpg') }}" class="w-5/5 h-3/5 rounded" alt="technology" />
                            <div class="p-4 pl-0">
                        ...
                        <div class="rounded w-full lg:w-1/2 lg:w-1/3 p-4 lg:p-0">
                            <img src="{{ asset('images/proj6.jpg') }}" class="w-5/5 h-3/5 rounded" alt="technology" />
                            <div class="p-4 pl-0">
                    ...
                    <!-- popular posts -->
                    <div class="flex mt-16 mb-4 px-4 lg:px-0 items-center justify-between">
                        <h2 class="font-bold text-3xl">Popular Art-Projects</h2>
                        <a class="bg-gray-200 hover:bg-green-200 text-gray-800 px-3 py-1 rounded cursor-pointer">
                            View all
                        </a>
                    </div>
