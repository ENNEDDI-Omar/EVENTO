                        ...
                        <li>
                            <a rel="noopener noreferrer" href=""
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/sv<path d="M64 48c-8.8 0-16 7.2-16 16V448c0 8.8
                                        7.2 16 16 16h80V400c0-26.5 21.5-48 48-48s48 21.5 48 48v64h80c8.8 0 16-7.2
                                        ...
                                        16-16h48c8.8 0 16 7.2 16 16v48c0 8.8-7.2 16-16 16H104c-8.8
                                        0-16-7.2-16-16V104zM232 88h48c8.8 0 16 7.2 16 16v48c0 8.8-7.2 16-16 16H232c-8.8
                                        0-16-7.2-16-16V104c0-8.8 7.2-16 16-16zM88 232c0-8.8 7.2-16 16-16h48c8.8 0 16 7.2
                                        16 16v48c0 8.8-7.2 16-16 16H104c-8.8 0-16-7.2-16-16V232zm144-16h48c8.8 0 16 7.2
                                        16 16v48c0 8.8-7.2 16-16 16H232c-8.8 0-16-7.2-16-16V232c0-8.8 7.2-16 16-16z" />
                                </svg>
                                </svg>
                            ...
                            <li>
                                <form action="{{ route('logout') }}" method="POST">
                                    ...
                                    <button type="submit" class="flex items-center p-2 space-x-3 rounded-md">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current dark:text-gray-400"><path d="M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 192 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l210.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128zM160 96c17.7 0 32-14.3 32-32s-14.3-32-32-32L96 32C43 32 0 75 0 128L0 384c0 53 43 96 96 96l64 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-64 0c-17.7 0-32-14.3-32-32l0-256c0-17.7 14.3-32 32-32l64 0z"/></svg>
                                        <span>Logout</span>
                                    </button>
                                </form>
                            </li>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.querySelectorAll('.assignButton').forEach(item => {
            item.addEventListener('click', event => {
                selectedUserId = null;
                // Get the company ID from the closest row's dataset
                const companyRow = event.target.closest('tr');
                selectedCompanyId = companyRow.dataset.companyId;
        ...
        document.getElementById('assignUserButton').addEventListener('click', () => {
            if (selectedCompanyId && selectedUserId) {
                fetch(`/assign-representative/${selectedCompanyId}/${selectedUserId}`, {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    const companyRow = document.querySelector(`tr[data-company-id="${selectedCompanyId}"]`);
                    companyRow.querySelector('.representative-column').textContent = data.representative_name;
                    document.getElementById('userSelectionModal').classList.add('hidden');
                })
                .catch(error => {
                ...
                console.error('Company or user not selected.');
            }
        });
