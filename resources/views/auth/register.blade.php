        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0"
            ...
            <div class="w-full py-6 z-20">
                ...
                <form method="POST" action="{{ route('register') }}" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                  @csrf
                    <div class="pb-2 pt-4">
                        <x-input-label class="text-left text-white" for="name" :value="__('Name:')" />
                        <x-text-input id="name" class="block w-full p-4 text-lg rounded-sm bg-black"
                            type="text" name="name" :value="old('name')" required autofocus autocomplete="name"
                            placeholder="Full-Name" />
                        <x-input-error :messages="$errors->get('name')" class="mt-2" />
                    </div>
                    <div class="pb-2 pt-4">
                        <x-input-label class="text-left text-white" for="email" :value="__('Email:')" />
                        <x-text-input id="email" class="block w-full p-4 text-lg rounded-sm bg-black"
                            type="email" name="email" :value="old('email')" required autocomplete="username"
                            placeholder="example@gmail.com" />
                        <x-input-error :messages="$errors->get('email')" class="mt-2" />
                    </div>
                    <div class="pb-2 pt-4">
                        <x-input-label class="text-left text-white" for="password" :value="__('Password:')" />
                        <x-text-input id="password" class="block w-full p-4 text-lg rounded-sm bg-black"
                    ...
                    <div class="pb-2 pt-4">
                        <x-input-label class="text-left text-white" for="confirme_password" :value="__('Confirme_Password:')" />
                        <x-text-input id="password_confirmation"
                            class="block w-full p-4 text-lg rounded-sm bg-black" type="password"
                    ...
                    <div>
                        <a href="{{ route('login') }}" class="underline text-sm text-white hover:text-indigo-600 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">{{ __('Already registered?') }}</a>
                    </div>
