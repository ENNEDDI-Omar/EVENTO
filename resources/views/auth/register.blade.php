    ...
    <section class="min-h-screen flex items-stretch text-white ">
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center"
            ...
            <div class="w-full px-24 z-10">
                ...
                <p class="text-3xl my-4">Reserve your Ticket and enjoy your moment in unique way, anywhere.</p>
            </div>
            ...
            <div class="w-full py-6 z-20">
                ...
                <form method="POST" action="{{ route('register') }}" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    ...
                    <div class="pb-2 pt-4">
                        ...
                        <x-text-input id="name" class="block w-full p-4 text-lg rounded-sm bg-black" type="text"
                    ...
                    <div class="pb-2 pt-4">
                        ...
                        <x-text-input id="email" class="block w-full p-4 text-lg rounded-sm bg-black" type="email"
                    ...
                    <div class="pb-2 pt-4">
                        ...
                        <x-text-input id="password_confirmation" class="block w-full p-4 text-lg rounded-sm bg-black"
